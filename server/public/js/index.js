...
/***/ (function(module, exports, __webpack_require__) {
	...
	var Lottery = function (_mix) {
	    ...
	    return Lottery;
	}(mix(_base2.default, _timer2.default, _calculate2.default, _interface2.default));
	    ...
	    _createClass(Timer, [{
	        ...
	        value: function countdown(end, update, handle) {
	            ...
	            if (now - end > 0) {
	                ...
	                var m = Math.floor((last_time - px_h * h - px_d * d) / px_m);
	                var s = Math.floor((last_time - px_m * m - px_h * h - px_d * d) / px_s);
